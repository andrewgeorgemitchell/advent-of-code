...
test('Day 01 - Part 1: Test input2 answer', async () => {
  const result = day01.findQuickestRoute(testInput2 as any)
  expect(result).toBe(2)
})

test('Day 01 - Part 1: Test input3 answer', async () => {
  const result = day01.findQuickestRoute(testInput3 as any)
  expect(result).toBe(12)
})

test('Day 01 - Part 1: Real input answer', async () => {
...
test('Day 01 - Part 2: Test input answer', async () => {
  const result = day01.findTwiceVisitedPoint(p2TestInput as any)
  expect(result).toBe(4)
})

test('Day 01 - Part 2: Real input answer', async () => {
  const input = await day01.parseFileInput()
