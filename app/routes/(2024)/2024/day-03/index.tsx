...
import rawTxt from './-day-03.data.txt?raw'

export const Route = createFileRoute('/(2024)/2024/day-03/')({
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col items-center gap-4 max-w-screen-sm mx-auto">
        <h3 className="text-2xl font-bold">--- Day 3: Mull It Over ---</h3>
        ...
        <div className="prose dark:prose-invert max-w-none">
          <p>
            At the North Pole Toboggan Rental Shop, you've been asked to help
            with a computer issue. The friendly shopkeeper explains that their
            computer is having problems, and they can't check their inventory.
            When you examine the computer, you discover its memory is corrupted,
            with all the instructions jumbled up. The program appears to be
            performing multiplications using mul(X,Y) instructions, but you'll
            need to carefully parse through the corrupted data to find the valid
            ones.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4 w-full">
          ...
          <p>
            Find all valid mul(X,Y) instructions in the corrupted memory and sum
            their results. A valid instruction must have exactly the format
        ...
        <div className="flex flex-col gap-4 w-full">
          ...
          <p>
            Now you need to handle conditional statements that enable or disable
          ...
          <ul className="list-disc list-inside">
            ...
            <li>Only the most recent do() or don't() instruction applies</li>
            <li>
              At the beginning of the program, mul instructions are enabled
            </li>
          </ul>
          <p>Find the sum of all enabled multiplication results.</p>
          <textarea
            value={input2}
