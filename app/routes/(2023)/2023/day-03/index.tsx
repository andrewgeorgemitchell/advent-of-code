...
export const Route = createFileRoute('/(2023)/2023/day-03/')({
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col items-center gap-4 max-w-screen-sm mx-auto">
        <h3 className="text-2xl font-bold">--- Day 03: Gear Ratios ---</h3>
        ...
        <div className="prose dark:prose-invert max-w-none">
          <p>
            The engine schematic contains numbers and symbols. Any number
            adjacent to a symbol (even diagonally) is a "part number" and should
            be included in the sum. Periods (.) do not count as symbols.
          </p>
        </div>
